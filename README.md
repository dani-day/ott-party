...
협업 프로젝트를 하면서 여러가지를 사전에 정해두는 것이 중요하다는 것을 알게 되었습니다.함께 하면서 문제 해결에 대한 다양한 시각을 확인했고 많은 도움을 받을 수 있었습니다. 좋은 팀원들을 만나게 되어 행운이었고 팀원에게 도움 줄 수 있는 개발자가 되기 위해 더욱 노력해야겠다고 다짐했습니다. ♥️
